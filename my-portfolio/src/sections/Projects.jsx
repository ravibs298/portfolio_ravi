const PROJECTS = [
  ...
  { title:'Portfolio Website',     desc:'A modern, responsive portfolio website showcasing projects and skills with smooth animations and interactive components.',          tags:['React','Tailwind CSS','Vite'],             demo:'#', code:'#', grad:'linear-gradient(135deg,#14b8a6,#4ade80)' },
]
